...
-- =====================================================
-- POLÍTICAS DE SEGURANÇA (Acesso Público)
-- Permite acesso sem login
-- =====================================================

CREATE POLICY "Allow all farms" ON farms FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all sectors" ON sectors FOR ALL USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow all cost_centers" ON cost_centers FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all expenses" ON expenses FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all revenues" ON revenues FOR ALL USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow all fiscal_issuers" ON fiscal_issuers FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all fiscal_recipients" ON fiscal_recipients FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all fiscal_operation_templates" ON fiscal_operation_templates FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all fiscal_products" ON fiscal_products FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all nfes" ON nfes FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all mdfes" ON mdfes FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all attachments" ON attachments FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all divergences" ON divergences FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all month_closings" ON month_closings FOR ALL USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow all season_costs" ON season_costs FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all barter_contracts" ON barter_contracts FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all lease_contracts" ON lease_contracts FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all lease_payments" ON lease_payments FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all forecasts" ON forecasts FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all financial_statements" ON financial_statements FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all asset_depreciations" ON asset_depreciations FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all user_subscriptions" ON user_subscriptions FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all excel_imports" ON excel_imports FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all import_previews" ON import_previews FOR ALL USING (true) WITH CHECK (true);
