...
const mockOperations: Operation[] = [
  { id: '1', sectorId: 's1', name: 'Operação 1', description: '', color: '#000', icon: '', isActive: true, createdAt: '2024-01-01' },
  { id: '2', sectorId: 's1', name: 'Operação 2', description: '', color: '#000', icon: '', isActive: true, createdAt: '2024-01-01' },
  { id: '3', sectorId: 's2', name: 'Operação 3', description: '', color: '#000', icon: '', isActive: true, createdAt: '2024-01-01' },
];

const mockSectors: Sector[] = [
  { id: 's1', name: 'Setor 1', description: '', color: '#000', icon: '', isActive: true, createdAt: '2024-01-01' },
  { id: 's2', name: 'Setor 2', description: '', color: '#000', icon: '', isActive: true, createdAt: '2024-01-01' },
];
